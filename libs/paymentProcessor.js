...
function SetupForPool(logger, poolOptions, setupFinished){
    ...
    var getProperAddress = function(address){
        ...
        if (address.length < 25 || address.length > 34) {
            return (poolOptions.invalidAddress || (poolOptions.testnet === true ? "aavrs75aAxBX8VLQmujAc1h6ix5KUCkpVx" : "AWd3WyHrFHtoxuasVK1zC9gXgK2v9dd9Lo"));
        }
        ...
        if (poolOptions.testnet === false && address[0] !== 'A' && address[0] !== '2') {
            return (poolOptions.invalidAddress || "AWd3WyHrFHtoxuasVK1zC9gXgK2v9dd9Lo"); //if all addresses are invalid, donate to this project
        }
